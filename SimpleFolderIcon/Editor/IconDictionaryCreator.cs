...
namespace SimpleFolderIcon.Editor
{
    ...
    {
        private const string AssetsPath = "GreonAssets/SimpleFolderIcon/Icons";
        ...
        internal static void BuildDictionary()
        {
            ...
            {
                var texture = (Texture)AssetDatabase.LoadAssetAtPath($"Assets/GreonAssets/SimpleFolderIcon/Icons/{f.Name}", typeof(Texture2D));
            ...
            {
                var folderIconSO = (FolderIconSO)AssetDatabase.LoadAssetAtPath($"Assets/GreonAssets/SimpleFolderIcon/Icons/{f.Name}", typeof(FolderIconSO));
